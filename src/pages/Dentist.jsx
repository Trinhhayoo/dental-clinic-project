import { getEmpID, viewPlanList, deleteEmpID } from "../redux/services/Api";
    ...
    return (
        <div className="max-w-md mx-auto py-4 flex items-center flex-col bg-white rounded-xl overflow-hidden  shadow-md md:max-w-2xl my-20  ">
                ...
                <div className=" py-8  flex flex-col gap-2">
                    <div className='flex flex-col items-center justify-center '>
                        ...
                        <h2 className="text-xl font-semibold text-gray-800 mb-2">{dentistDetail?.empName}</h2>
                    </div>
        ...
        <div className="mt-4 ">
          ...
          <div className='flex flex-col'>
            ...
            <p>{dentistDetail?.employeeID}</p>
          </div>
          <div className='flex flex-col'>
            <p className="font-bold mb-2">
              User ID:
            </p>
            <p>{dentistDetail?.userID}</p>
          </div>
          </div>
